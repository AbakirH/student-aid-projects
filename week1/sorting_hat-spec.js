...
describe("sorting_hat", function(){
    ...
    it("it should throw an error if argument given is not an array of strings (names) with at least 1 element", function(){
        expect(()=>sorting_hat([])).toThrow();
    });
    // it should return another array of the same length as the given array
    it("it should return another array of the same length as the given array", function(){
      var theArr = ['Gryffindor','Hufflepuff', 'Ravenclaw','Slytherin'];
      var a = theArr.length;
      expect(sorting_hat(theArr).filter(x=>x==='Gryffindor'|| 'Hufflepuff' || "Ravenclaw" ||"Slytherin").length).toBe(4);;
    });
    ...
    expect(sorting_hat(['Harry as','Hufflasdepuff', 'sa','Slytherin'])).toContain('Gryffindor'|| 'Hufflepuff' || "Ravenclaw" ||"Slytherin");
    });
    ...
    it("it should assign 'Gryffindor' to 'Harry Potter', if the name appears in the given array", function(){
      expect(sorting_hat(['Harry Potter','Hufflepuff', 'Ravenclaw','Slytherin'])).toContain("Gryffindor");
    });
    ...
    it("it should assign 'Slytherin' to 'Voldemort', if the name appears in the given array", function(){
      expect(sorting_hat(['Gryffindor','Hufflepuff', 'Ravenclaw','Voldemort'])).toContain("Slytherin");
    });
